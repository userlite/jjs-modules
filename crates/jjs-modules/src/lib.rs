...
pub const TPS_DEFAULT_PROFILE_ID: &str = "tps-default-v3";
...
mod tests {
    ...
    fn default_profile_has_stable_identity_and_complete_catalog() {
        ...
        assert_eq!(profile.id, "tps-default-v3");
        assert_eq!(profile.catalog.selections.len(), 11);
